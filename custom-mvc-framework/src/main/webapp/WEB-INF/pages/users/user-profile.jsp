                                        ...
                                        <div class="active tab-pane" id="activity">
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    ...
                                                    <c:url value="/static-content/images/user1-128x128.jpg" var="imagesUser1"></c:url>
                                                    <img class="img-circle img-bordered-sm" src="${imagesUser1}" alt="user image"> 
                                                    
                                                    
                                                    
                                                    
                                                    <span
                                                        class="username"> <a href="#">Jonathan Burke Jr.</a> <a href="#" class="float-right btn-tool"><i
                                                ...
                                                <p>
                                                    <a href="#" class="link-black text-sm mr-2"><i class="fas fa-share mr-1"></i> Share</a> <a href="#"
                                                        class="link-black text-sm"><i class="far fa-thumbs-up mr-1"></i> Like</a> <span class="float-right"> <a
                                                        href="#" class="link-black text-sm"> <i class="far fa-comments mr-1"></i> Comments (5)
                                                    </a>
                                                    </span>
                                                </p>
                                            ...
                                            <div class="post clearfix">
                                                <div class="user-block">
                                                    ...
                                                    <img class="img-circle img-bordered-sm" src="${imagesUser7}" alt="User Image"> 
                                                    
                                                    
                                                    
                                                    <span
                                                        class="username"> <a href="#">Sarah Ross</a> <a href="#" class="float-right btn-tool"><i
                                                            class="fas fa-times"></i></a>
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    ...
                                                    <c:url value="/static-content/images/user6-128x128.jpg" var="imagesUser6"></c:url>
                                                    <img class="img-circle img-bordered-sm" src="${imagesUser6}" alt="User Image"> 
                                                    
                                                    
                                                    <span
                                                        class="username"> <a href="#">Adam Jones</a> <a href="#" class="float-right btn-tool"><i
                                                            class="fas fa-times"></i></a>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <c:url value="/static-content/images/photo1.png" var="photo1"></c:url> 
                                                        <img class="img-fluid" src="${photo1}" alt="Photo">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <c:url value="/static-content/images/photo2.png" var="photo2"></c:url>
                                                                <img class="img-fluid mb-3" src="${photo2}" alt="Photo">

                                                                <c:url value="/static-content/images/photo3.jpg" var="photo3"></c:url>
                                                                <img class="img-fluid" src="${photo3}" alt="Photo">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <c:url value="/static-content/images/photo4.jpg" var="photo4"></c:url>
                                                                <img class="img-fluid mb-3" src="${photo4}" alt="Photo">
                                                                <img class="img-fluid" src="${photo1}" alt="Photo">
                                            ...
                                            <div class="timeline timeline-inverse">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-body">Take me to your leader! Switzerland is small and neutral! We are more like
                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-body">
                                                            ...
                                                            <img src="http://placehold.it/150x100" alt="..."> <img src="http://placehold.it/150x100" alt="...">
                                                            <img src="http://placehold.it/150x100" alt="..."> <img src="http://placehold.it/150x100" alt="...">
